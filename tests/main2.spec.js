...
import FizzBuzz from '../src/main2.js';
...
describe('FizzBuzz', () => {
    ...
    it('should return `Fizz` when multiple of 3', () => {
      ...
      it('should return `FizzBuzz` when mutiple of 3 and 5', () => {
        expect(FizzBuzz(15)).to.be.equal('FizzBuzz');
        expect(FizzBuzz(150)).to.be.equal('FizzBuzz');
      });

      it('should return the number when now-multiple', () => {
